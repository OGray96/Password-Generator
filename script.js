...
var generatePassword = function(){
  var userChoiceLength = window.prompt("Please input how long you would like your password to bes. Please note that a password must be a length between 8-128 characters");
